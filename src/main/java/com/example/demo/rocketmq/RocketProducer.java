...
public class RocketProducer {
     ...
     * 普通类型测试
     */
    @GetMapping("/rmq/send/{msg}")
    public String send(@PathVariable String msg) throws Exception{ //mq的消息发送
        Message message = new Message("orderTopic",null,null,msg.getBytes());
